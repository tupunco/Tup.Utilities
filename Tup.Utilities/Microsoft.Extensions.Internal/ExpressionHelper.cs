// FROM: https://github.com/dotnet/aspnetcore/blob/v3.1.11/src/Mvc/Mvc.ViewFeatures/src/ExpressionHelper.cs
// FROM: https://github.com/dotnet/aspnetcore/blob/v3.1.11/src/Mvc/Mvc.ViewFeatures/src/ModelExpressionProvider.cs
...
{
    /// <summary>
    /// System.Linq.Expressions.Expression Helper
    /// </summary>
    /// <remarks>
    /// FROM: https://github.com/dotnet/aspnetcore/blob/v3.1.11/src/Mvc/Mvc.ViewFeatures/src/ExpressionHelper.cs
    /// </remarks>
    public static class ExpressionHelper
    {
        ...
        private static readonly ConcurrentDictionary<LambdaExpression, string> _expressionTextCache
        ...
        public static string GetExpressionText<TModel, TValue>(Expression<Func<TModel, TValue>> expression)
        {
            if (expression == null)
            {
                throw new ArgumentNullException(nameof(expression));
        ...
        internal static string GetExpressionText(LambdaExpression expression, ConcurrentDictionary<LambdaExpression, string> expressionTextCache)
        {
            if (expression == null)
            {
                throw new ArgumentNullException(nameof(expression));
