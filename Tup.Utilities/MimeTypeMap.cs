...
namespace Tup.Utilities
{
    ...
    public static class MimeTypeMap
    {
        ...
        private static readonly string _defaultMime = "application/octet-stream";
        ...
        public static string GetMimeType(string extension)
        {
            ...
            return _mappings.Value.GetValue(extension, _defaultMime);
        }

        /// <summary>
        /// 获取某 `MIME` 的 `扩展名`, 未找到 `抛出异常`
        /// </summary>
        ...
        /// </summary>
        /// <param name="mimeType"></param>
        /// <param name="throwErrorIfNotFound">未找到是否 `抛出异常`</param>
        /// <returns></returns>
